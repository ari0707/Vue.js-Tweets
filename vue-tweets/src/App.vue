<template>
  <div class="app">
    <Tweet v-for="(tweet, index) in tweets" :key="index" :user="tweet.user" :timestamp="tweet.timestamp" :message="tweet.message" :name="tweet.user.name" :image="tweet.user.image" :handle="tweet.user.handle"/>
  </div>
</template>
